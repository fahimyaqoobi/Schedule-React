...
export async function appendJobActivityMessage(adminDb, { bookingId, summary, by, attachment }) {
    ...
    const message = {
        ...
        text: summary,
        createdAt: nowIso,
        // A point-in-time snapshot of a generated PDF (see
        // lib/documentStorage.js) — { url, name, mimeType } — lets an admin
        // reopen exactly what was downloaded/sent at that moment, even if
        // the booking's numbers changed since. ChatPanel already knows how
        // to render this (thumbnail for images, a file chip otherwise).
