...
import { getBookingDocumentContext, formatDate, formatMoney } from "./bookingDocuments";
...
export async function buildBookingDocumentPdf(booking = {}, options = {}) {
    ...
    const totalLabel = context.documentLabel === "Receipt" ? "Amount paid" : "Amount due";
    ...
    addText(termsText, margin, y, { size: SIZE.small - 1.5, color: faint, width: contentWidth, lineBreak: true, lineGap: 2 });
    y += termsHeight + 20;
