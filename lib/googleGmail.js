...
//
// Text only — a multipart/mixed attachment version was tried and confirmed
// via a real send that Google's Local Services relay strips the file
// before it reaches the customer (plain text arrives, no attachment, no
// link), so that path was removed rather than left as a button that quietly
// doesn't work.
